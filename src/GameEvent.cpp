            ...
            switch(event.GUIEvent.EventType)
            {
                ...
                case EGET_BUTTON_CLICKED:
                    ...
                    case GUI_ID_INSTRUCTIONS_BUTTON:
                        env->clear();
                        env->addImage(Context.device->getVideoDriver()->getTexture("data/interface_instruction.jpeg"), vector2d<s32>(0, 0), false);
                        env->addButton(rect<s32>(270, 380, 370, 420), NULL, GUI_ID_INSTRUCTIONS_BACK_BUTTON, L"Retour");
                        break;

                    case GUI_ID_INSTRUCTIONS_BACK_BUTTON:
                        env->clear();
                        env->addImage(Context.device->getVideoDriver()->getTexture("data/interface_jeu.jpeg"), vector2d<s32>(0, 0), false);
                    ...
                    case GUI_ID_CONTROLS_BUTTON:
                        env->clear();
                        env->addImage(Context.device->getVideoDriver()->getTexture("data/interface_commande.jpeg"), vector2d<s32>(0, 0), false);
