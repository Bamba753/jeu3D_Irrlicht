...
void Game::initInterface()
{
    ...
    env->addImage(device->getVideoDriver()->getTexture("data/interface_jeu.jpeg"), vector2d<s32>(0, 0), false);
...
void Game::displayPauseMenu()
{
    ...
    env->addButton(rect<s32>(50,110, 200, 150), 0, GUI_ID_INSTRUCTIONS_BUTTON_PAUSE, L"Instructions", L"Si t'es prêt. Check les intructions de la mission");
    //env->addButton(rect<s32>(50, 170, 200, 210), 0, GUI_ID_CONTROLS_BUTTON_PAUSE, L"Commandes", L"Tu veux savoir les touches pour jouer. Press!!!");
...
void Game::displayGameOverMenu()
{
    ...
    env->addImage(device->getVideoDriver()->getTexture("data/interface_gameOver.jpeg"), vector2d<s32>(0, 0), false);
    env->addButton(rect<s32>(50, 320, 295, 360), 0, GUI_ID_RESTART_BUTTON,
            L"Recommencer", L"T'es chaud. Vas y !!!");
    env->addButton(rect<s32>(345, 320, 590, 360), 0, GUI_ID_QUIT_BUTTON,
            L"Quiter le jeu", L"Ah noooon. Tu veux quitter le jeu?");
    env->drawAll();
...
void Game::displayGameCompleteMenu()
{
    ...
    env->addImage(device->getVideoDriver()->getTexture("data/interface_gameComplete.jpeg"), vector2d<s32>(0, 0), false);
    env->addButton(rect<s32>(50, 320, 295, 360), 0, GUI_ID_RESTART_BUTTON,
            L"Recommencer", L"T'es chaud. Vas y !!!");
    env->addButton(rect<s32>(345, 320, 590, 360), 0, GUI_ID_QUIT_BUTTON,
            L"Quiter le jeu", L"Ah noooon. Tu veux quitter le jeu?");
