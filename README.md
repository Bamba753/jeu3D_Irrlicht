...
Pour compiler, il faut ouvrir le dossier src. On y trouve le Makefile. Il faudra alors l'ouvrir dans un terminal et faire un make. L'exécutable "survive" sera créé.
Pour lancer le jeu, il faut lancer l'exécutable ./survive.
